...
public class DragListView extends ListView implements OnScrollListener, OnClickListener {
	...
	public OnRefreshLoadingMoreListener onRefreshLoadingMoreListener;
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.frame_header, null);
		...
		state = DONE;
			...
			mFootView = LayoutInflater.from(context).inflate(R.layout.frame_footer, null);
	
			mLoadMoreView = mFootView.findViewById(R.id.frame_load_more_view);
	
			mLoadMoreTextView = (TextView) mFootView
					.findViewById(R.id.frame_load_more_tv);
...
//			if(context.belongTab()){
//				MainActivity.dismissSelector();
//			}
...
//		}
	...
	public void onLoadMoreComplated(boolean noMore){
		this.noMore = noMore;
		if(noMore){
